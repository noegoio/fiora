...
function Expression(props: ExpressionProps) {
    ...
    if (keywords) {
      ...
      if (result) {
        if (result.length !== 0) {
          ...
          Message.info('No related expressions, try another keyword')
        }
      }
      ...
      <div className={Style.searchResult}>
        {searchResults.map((image, index) => (
          ...
          <img
            ...
            src={image}
            alt="expression"
            // May return the same picture multiple times, resulting in the same key
  ...
  return (
    <div className={Style.expression}>
      ...
      >
        <TabPane tab="Default emoji" key="default">
